...
import com.example.knight.libraryutils.annotation.DownloadStatus;
...
public class DownloadFileInfo {
    ...
    public DownloadFileInfo(String url, String saveFileName, String saveFileDir, ProgressCallback progressCallback) {
        this.url = url;
        this.saveFileName = saveFileName;
